...
export default function ServicesTab() {
  ...
  const { currentCurrency } = useClinicContext();
  ...
  const handleAdd = () => {
    if (!name) return;
    const newServices = [...data.services, { name, price }];
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-7">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 h-full">
          <h6 className="font-bold text-slate-900 mb-4">دليل الخدمات والباقات المتاحة</h6>
